...
public class PermissionUtil {
	...
	/**
	 * 根据指定包名, 使用反射机制找@controller注解的所有类
	 * 中的所有@RequiresPermissions注解和@RequiresPermissionsDesc注解的权限
	 * @param context
	 * @param basicPackage 指定包名
	 * @return
	 */
	...
	/**
	 * 将权限实体集合转换成权限字符串集合
	 * 返回值例如: admin:category:list或者admin:category:read等
	 * @param permissions
	 * @return
	 */
